  ...
  return (
    <div className="tweet">
      <div className="header">
        <img
          src={tweet.avatar} alt="avatar" className="avatar"
        />
        <p className="name">
          {tweet.name}
          <span>
      ...
      <div className="icons">
        <div>
          ...
          <span className="icon-text">&nbsp;&nbsp;{tweet.comments}</span>
        </div>
        <div>
          <svg
            height="18px"
          ...
          <span className="icon-text">&nbsp;&nbsp;{tweet.retweets}</span>
        </div>
        <div>
          <svg
            height="18px"
          ...
          <span className="icon-text">&nbsp;&nbsp;{tweet.likes}</span>
        </div>
        <div>
          <svg
            height="18px"
